...
def clear_database_gui():
    if messagebox.askyesno("Confirm Clear", "Are you sure you want to clear the database? This action cannot be undone."):
        if clear_database():
...
def admin_menu():
    ...
    tk.Button(admin_window, text="Place Report", command=generate_place_report).pack(pady=10)  # New button for place report
